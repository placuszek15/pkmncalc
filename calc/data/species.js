...
var Specie = (function () {
    function Specie(name, data) {
        ...
        this.name = name;
        var baseStats = {};
        this.bst_scale = data.bs.at + data.bs.df + data.bs.sa + data.bs.sd + data.bs.sp;
        this.mult = (600 - data.bs.hp) / this.bst_scale        
                
        baseStats.hp = data.bs.hp;
        baseStats.atk = Math.min(Math.floor(data.bs.at*this.mult), 255);
        baseStats.def = Math.min(Math.floor(data.bs.df*this.mult), 255);
        baseStats.spa = gen >= 2 ? data.bs.sa : data.bs.sl;
        baseStats.spa = Math.min(Math.floor(baseStats.spa*this.mult),255);
        baseStats.spd = gen >= 2 ? data.bs.sd : data.bs.sl;
        baseStats.spd = Math.min(Math.floor(baseStats.spd*this.mult),255);
        baseStats.spe = Math.min(Math.floor(data.bs.sp*this.mult),255);
        //console.log(name,"\n",baseStats,"\n",data,"\n",this.mult,"\n",this.bst_scale)
...
for (var _i = 0, SPECIES_1 = exports.SPECIES; _i < SPECIES_1.length; _i++) {
    //console.log(SPECIES_BY_ID, SPECIES_1, _i)
